    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SuperMasterNode") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SuperMasterNode"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  smn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the SuperMasterNode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SMN, 0.01 SMN, 0.1 SMN, 1 SMN and 10 SMN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.smn.org/en/latest/wallets/smn/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SuperMasterNode is shutting down...") + "<br /><br />" +
