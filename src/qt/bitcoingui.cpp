    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SuperMasterNode") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SuperMasterNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smn: URIs)"));
    ...
    connect(explorerAction, SIGNAL(triggered()), this, SLOT(gotoExplorerPage1()));
#endif // ENABLE_WALLET
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SuperMasterNode"), this);
    aboutAction->setStatusTip(tr("Show information about SuperMasterNode"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SuperMasterNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SuperMasterNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SuperMasterNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a smn: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SuperMasterNode help message to get a list with possible SuperMasterNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SuperMasterNode client") + " " + networkStyle->getTitleAddText();
...
{
    QUrl AuthorUrl("http://smncoin.com/");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SuperMasterNode network", "", count));
    } else {
...
{
    QString strTitle = tr("SuperMasterNode"); // default title
    ...
    // Append title to "SuperMasterNode - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
