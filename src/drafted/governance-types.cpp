...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SuperMasterNodeNetwork") type = SuperMasterNodeNetwork;
    if(strType == "SuperMasterNodeNetworkVariable") type = SuperMasterNodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SuperMasterNodeNetwork) s = "SuperMasterNodeNetwork";
    if(type == SuperMasterNodeNetworkVariable) s = "SuperMasterNodeNetworkVariable";
