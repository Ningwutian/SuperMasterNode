 ...
 *
 *   // network
 *   CSuperMasterNodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.smn.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSuperMasterNodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSuperMasterNodeNetwork(UniValue objIn)
    {
...
// // can be under: SuperMasterNodeNetwork
// //   -- signature requirements : Key1(User)
// class CSuperMasterNodeNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SuperMasterNodeNetwork);
//     // }
