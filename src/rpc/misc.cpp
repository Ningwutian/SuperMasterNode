...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total smn balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized smn balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "smn|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "smn")
            + HelpExampleRpc("debug", "smn,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"smnaddress\"\n"
            "\nReturn information about the given smn address.\n"
            "\nArguments:\n"
            "1. \"smnaddress\"     (string, required) The smn address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"smnaddress\", (string) The smn address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"")
            + HelpExampleRpc("validateaddress", "\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: SuperMasterNode address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are smn addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) smn address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"smnaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"smnaddress\"  (string, required) The smn address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"SPQuTxPDEgT5oCvcgP2UPwc5ku6czQAjN8\"]}")
        );
