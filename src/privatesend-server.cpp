...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all SuperMasterNode related functionality
...
/*
    ...
    allow endless transaction that would bloat SuperMasterNode and make it unusable. To
