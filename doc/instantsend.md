...
This mechanism has been integrated into Bitcore-Node-SuperMasterNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/smnpay/insight-api-smn#web-socket-api](https://github.com/smnpay/insight-api-smn#web-socket-api)
* API: [https://github.com/smnpay/insight-api-smn#instantsend-transactions](https://github.com/smnpay/insight-api-smn#instantsend-transactions)
...
By default, the SuperMasterNode daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SuperMasterNode daemon:
