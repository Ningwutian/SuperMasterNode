...
Only requiring some minor changes is smn.cpp.
...
Changes to smn.cpp
----------------------
smn.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
